...
# caption and icon
pygame.display.set_caption("Catch 'Em All by: Winston Bullock")
...
def game_over():
    global game_over
    game_over_text = game_over_font.render("GET GUD NOOB", True, (0, 0, 0))
    screen.blit(game_over_text, (150, 250))

 
# player
playerImage = pygame.image.load('data/spaceship.png')
playerImageSize = (80, 80)
playerImage = pygame.transform.scale(playerImage, playerImageSize)
player_X = 370
player_Y = 523
player_Xchange = 0
...
#Invader Size
invaderPicture = pygame.image.load('data/alien.png')
invaderSize = (135, 135)
invaderPicture = pygame.transform.scale(invaderPicture, invaderSize)

for num in range(no_of_invaders):
    #invaderImage.append(pygame.image.load('data/alien.png'))
    invaderImage.append(invaderPicture)
...
bulletImageSize = (45, 45)
bulletImage = pygame.transform.scale(bulletImage, bulletImageSize)
bullet_X = 0
bullet_Y = 600
bullet_Xchange = 0
bullet_Ychange = 5
